...
Installs Playwright browsers for JavaScript rendering
...
🔌 Quick Start
Create a new .js file in this folder (e.g., my-plugin.js)
Register your plugin using the LibreCrawl Plugin API
